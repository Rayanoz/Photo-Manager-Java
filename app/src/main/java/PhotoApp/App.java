...
public class App {
    public static void main(String[] args) {
        ...
        // Photo photo1 = new Photo("hedgehog.jpg",toTagsLinkedList("animal, hedgehog,
        // apple,
        // grass, green"));
        // manager.addPhoto(photo1);
        // Photo photo2 = new Photo("bear.jpg",toTagsLinkedList("animal, bear, cab,
        // grass,
        // wind"));
        // manager.addPhoto(photo2);
        // Photo photo3 = new Photo("orange-butterfly.jpg",toTagsLinkedList("insect,
